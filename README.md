...
## Что проверили и отвергли — ablation
...
- **Сокомандник сдал основное решение** (CatBoost (TARGET_2) / CatBoost + LightGBM бленд (TARGET_1) + глобальный correction для компенсации дрейфа, ~14.92% на лидерборде). Моя ветка — независимая
  альтернатива с акцентом на drift-диагностику и динамическую калибровку по возрасту.